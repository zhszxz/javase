...
public class WeatherService {
    ...
    // 替换成你自己的和风天气API密钥
    private static final String API_KEY = "b0ad1dd68b2449d8acc74507f2af5af6";
    // 调用的url地址和指定的城市，本案例以北京为例
    private static final String BASE_URL = "https://mp4d93cvmt.re.qweatherapi.com/v7/weather/now?location=%s&key=%s";
